...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Payment failed, so you can\'t access the course.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'The payment was successful so you can access the course on your courses list.'**
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['ar', 'en', 'ms', 'tw', 'zh'].contains(locale.languageCode);
